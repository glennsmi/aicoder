export default function AboutPage() {
  return (
    <div className="min-h-screen bg-sand-300 dark:bg-secondary-900">
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="space-y-8">
            ...
            <div className="bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6 border-l-4 border-primary-500">
              <p className="text-lg text-neutral-700 dark:text-sand-300 italic">
            ...
            <div>
              ...
              <p className="text-lg text-neutral-700 dark:text-sand-300 leading-relaxed mb-4">
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">
              <span className="text-neutral-900 dark:text-white">Our Mission: </span>
          ...
          <div className="space-y-8">
            <div>
              <p className="text-lg text-neutral-700 dark:text-sand-300 leading-relaxed mb-4">
                As we used our own tool, we discovered something unexpected: <strong className="text-neutral-900 dark:text-white">visibility doesn't just help you manage costs—it helps you encourage adoption</strong>.
              </p>
              <p className="text-lg text-neutral-700 dark:text-sand-300 leading-relaxed">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <div className="bg-sand-300 dark:bg-secondary-900 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-700">
                <div className="text-4xl font-bold text-primary-500 mb-2">1,000+</div>
                <div className="text-neutral-700 dark:text-sand-300">Development Teams</div>
              </div>
              <div className="bg-sand-300 dark:bg-secondary-900 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-700">
                <div className="text-4xl font-bold text-primary-500 mb-2">50M+</div>
                <div className="text-neutral-700 dark:text-sand-300">Tokens Tracked</div>
              </div>
              <div className="bg-sand-300 dark:bg-secondary-900 rounded-xl p-6 text-center border border-gray-200 dark:border-gray-700">
                <div className="text-4xl font-bold text-secondary-600 dark:text-white mb-2">87%</div>
                <div className="text-neutral-700 dark:text-sand-300">Avg. Adoption Rate</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-sand-100 dark:bg-secondary-800 rounded-xl p-8 border border-gray-200 dark:border-gray-700">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-500 to-primary-500">
        <div className="container mx-auto max-w-4xl text-center">
