...
const mailerSendApiKey = process.env.MAILER_SEND_KEY
...
const defaultSender = new Sender('[email protected]', 'AICoder.Guru')
...
export async function sendAdminNotification(
  ...
  try {
    ...
    const emailParams = new EmailParams()
      .setFrom(defaultSender)
      .setTo([new Recipient('[email protected]', 'Glenn Smith')])
